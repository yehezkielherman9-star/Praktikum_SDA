...
void popRiwayat(Tiket* s) {
    if (top == -1) {
        cout << "Riwayat kosong!\n";
        return;
    }

    cout << "Hapus: " << (s + top)->namaPenumpang << endl;
    top--;
}
...
int main() {
    ...
    do {
        ...
        cout << "10. Peek Antrian\n";
        cout << "11. Hapus Riwayat (Pop)\n";
        cout << "12. Tampil Riwayat\n";
        cout << "13. Peek Riwayat\n";
        cout << "0. Keluar\n";
        cout << "Pilih: ";
        cin >> pilihan;
        ...
        switch (pilihan) {
            ...
            case 8: dequeue(antrian, riwayat); break;
            case 9: tampilAntrian(antrian); break;
            case 10: peekAntrian(antrian); break;
            case 11: popRiwayat(riwayat); break;
            case 12: tampilRiwayat(riwayat); break;
            case 13: peekRiwayat(riwayat); break;
        }
